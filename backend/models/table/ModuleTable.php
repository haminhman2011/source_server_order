...
class ModuleTable extends DataTable
{
    ...
    public function getData()
    {
        ...
        foreach ($models as $model) {
            $htmlAction  = " <a class='btn btn-info btn-update-module' data-id='$model->id'><i class='fa fa-pencil'></i> </a>";
            $htmlAction  .= " <a class='btn btn-danger btn-delete-module' data-id='$model->id'><i class='fa fa-trash'></i> </a>";
            $dataArray[] = [
                $model->name,
                $htmlAction
            ];
