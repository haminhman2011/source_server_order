...
const App = function() {
    ...
    const handleMaterialDesign = function() {
        ...
        if ($('body').hasClass('page-md')) {
            ...
            $('body').
                on('click', 'a.btn, button.btn, input.btn, label.btn',
                    function(e) {
                        element = $(this);

                        if (element.find('.md-click-circle').length == 0) {
                            element.prepend(
                                '<span class=\'md-click-circle\'></span>');
                        }
    ...
    const handleiCheck = function() {
        ...
        $('.icheck').each(function() {
            const checkboxClass = $(this).attr('data-checkbox') ? $(this).
   ...
   const handleHeight = function() {
       $('[data-auto-height]').each(function() {
           ...
           items.each(function() {
               ...
               const height_ = (mode == 'base-height' ? $(this).outerHeight() : $(
                   this).
                   outerHeight(true));
               if (height_ > height) {
                   height = height_;
    ...
    return {
        ...
        alert: function(options) {
            ...
            const html = '<div id="' + id + '" class="custom-alerts alert alert-' +
