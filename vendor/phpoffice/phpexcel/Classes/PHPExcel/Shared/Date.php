...
class PHPExcel_Shared_Date
{
     ...
     *
     * @param    mixed $dateValue PHP serialized date/time or date object a UST timestamp, or adjusted to UST
     * @param    string $timezone The timezone for finding the adjustment from UST
     *
     * @return    mixed        Excel date/time value or boolean FALSE on failure
     */
    public static function PHPToExcel($dateValue = 0, $timezone = null)
    {
        $saveTimeZone = empty($timezone) == null ? 'UTC' : $timezone;
     ...
     * @param    int $seconds
     *
     * @return  string    Excel date/time value
     */
