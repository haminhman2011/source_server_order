...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            $app->getUrlManager()->addRules([
                ...
                ['class' => UrlRule::class, 'pattern' => $this->id . '/<id:\w+>', 'route' => $this->id . '/default/view'],
                ['class' => UrlRule::class, 'pattern' => $this->id . '/<controller:[\w\-]+>/<action:[\w\-]+>', 'route' => $this->id . '/<controller>/<action>'],
            ], false);
        } elseif ($app instanceof \yii\console\Application) {
            $app->controllerMap[$this->id] = [
                'class'      => console\GenerateController::class,
    ...
    {
        return [
            'doubleModel' => ['class' => generators\doubleModel\Generator::class],
            'models'      => ['class' => generators\models\Generator::class],
//            'model'      => ['class' => generators\model\Generator::class],
            'enum'        => ['class' => generators\enum\Generator::class],
            'crud'        => ['class' => generators\crud\Generator::class],
            'cruds'       => ['class' => generators\cruds\Generator::class],
            'module'      => ['class' => generators\module\Generator::class],
        ];
    }
}
