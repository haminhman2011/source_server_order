yii.gii = (function ($) {
    ...
    return {
        ...
        init: function () {
            ...
            $('.team-generator #generator-tablename').change(function () {
            ...
            $('.team-generator #generator-tablename').on('blur', function () {
            ...
            $('.team-generator #generator-modelclass').on('blur', function () {
            ...
            $('.team-generator #generator-ns').on('blur', function () {
                var stickyValue = $('.team-generator .field-generator-queryns .sticky-value');
                var input = $('.team-generator #generator-queryns');
                if (stickyValue.is(':visible') || !input.is(':visible')) {
                    var ns = $(this).val();
                    stickyValue.html(ns + '\\query');
                    input.val(ns + '\\query');
                }
            });
            ...
            // hide module name when isModule is disabled
            $('form #generator-ismodule').change(function () {
                $('form .field-generator-viewpath').toggle($(this).is(':checked'));
            }).change();
            //hide detail name when isModule is disabled
            $('form #generator-hasdetail').change(function () {
                $('form .field-generator-exportdetail').toggle($(this).is(':checked'));
                $('form .field-generator-subtablename').toggle($(this).is(':checked'));
                $('form .field-generator-hassubdetail').toggle($(this).is(':checked'));
            }).change();
            //hide sub detail name when isModule is disabled
            $('form #generator-hassubdetail').change(function () {
                $('form .field-generator-subdetailtablename').toggle($(this).is(':checked'));
            }).change();
            //hide behaviors when generatebeforesave is disabled
            $('form #generator-generatebeforesave').change(function () {
                $('form .beforeSaveValue').toggle($(this).is(':checked'));
            }).change();
