            ...
            switch (match[5].length) {
                case 2: // military
                    if (timezoneIndex === 0) {
                        ...
                        timezoneIndex = military.indexOf(
                                match[5][1].toUpperCase()) - 12;
                        timezone = ((timezoneIndex < 0) ? ' -' : ' +') +
                            (('' + timezoneIndex).replace(/^-?/, '0')).match(
                                /..$/)[0] + '00';
                    }
                    break;
                case 4: // Zone
...
// TODO: remove 'name' arg after deprecation is removed
    ...
    function isBetween(from, to, units, inclusivity) {
        ...
        return (inclusivity[0] === '('
            ...
            (inclusivity[1] === ')' ? this.isBefore(to, units) : !this.isAfter(
                to, units));
    }
...
// PARSING
    ...
    addRegexToken('Do', function(isStrict, locale) {
        // TODO: Remove "ordinalParse" fallback in next major release.
        return isStrict ? (locale._dayOfMonthOrdinalParse ||
        locale._ordinalParse) : locale._dayOfMonthOrdinalParseLenient;
    });
...
//! Author : Menelion Elensúle : https://github.com/Oire
    ...
    function plural(word, num) {
        ...
        return num % 10 === 1 && num % 100 !== 11 ? forms[0] : (num % 10 >= 2 &&
        num % 10 <= 4 && (num % 100 < 10 || num % 100 >= 20)
            ? forms[1]
            : forms[2]);
    }
...
//! author : petrbela : https://github.com/petrbela
    ...
    hooks.defineLocale('cs', {
        ...
        shortMonthsParse: (function(monthsShort) {
            ...
            for (i = 0; i < 12; i++) {
                _shortMonthsParse[i] = new RegExp('^' + monthsShort[i] + '$',
                    'i');
            }
    ...
    hooks.defineLocale('cv', {
        ...
        relativeTime: {
            future: function(output) {
                var affix = /сехет$/i.exec(output) ? 'рен' : /ҫул$/i.exec(
                    output) ? 'тан' : 'ран';
                return output + affix;
            },
            past: '%s каялла',
...
//! author : Irakli Janiashvili : https://github.com/irakli-janiashvili
    ...
    hooks.defineLocale('ka', {
        ...
        relativeTime: {
            future: function(s) {
                return (/(წამი|წუთი|საათი|წელი)/).test(s) ? s.replace(/ი$/,
                    'ში') : s + 'ში';
            },
            past: function(s) {
